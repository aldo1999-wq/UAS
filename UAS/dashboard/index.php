...
<head>
    ...
    <title>Data Pemantauan | Dashboard</title>
...
<body>
    ...
    <section id="status">
        <div class="container">
            <div class="row mb-3">
                ...
                <!-- Menampilkan data positif covid yang sudah dihitung dari semua wilayah -->
                <?php
                include '../db_connect.php';
                $query = mysqli_query($connection, "SELECT SUM(positif) FROM data_covid");
                    ...
                    <div class="col-sm-3">
                        <div class="card text-white bg-secondary mb-3 shadow-sm">
                            <div class="card-body">
                                ...
                                <p class="card-text text-center fw-bolder" style="font-size: 30px;">
                                    <?= number_format($data['SUM(positif)'], 0) ?>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Menampilkan data Dirawat covid yang sudah dihitung dari semua wilayah -->
                <?php
                include '../db_connect.php';
                $query = mysqli_query($connection, "SELECT SUM(dirawat) FROM data_covid");
                while ($data = mysqli_fetch_array($query)) {
                ?>
                    <div class="col-sm-3">
                        <div class="card text-white bg-info mb-3 shadow-sm">
                            <div class="card-body">
                                ...
                                <p class="card-text text-center fw-bolder" style="font-size: 30px;">
                                    <?= number_format($data['SUM(dirawat)'], 0) ?>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Menampilkan data Sembuh covid yang sudah dihitung dari semua wilayah -->
                <?php
                include '../db_connect.php';
                $query = mysqli_query($connection, "SELECT SUM(sembuh) FROM data_covid");
                while ($data = mysqli_fetch_array($query)) {
                ?>
                    <div class="col-sm-3">
                        <div class="card text-white bg-success mb-3 shadow-sm">
                            <div class="card-body">
                                ...
                                <p class="card-text text-center fw-bolder" style="font-size: 30px;">
                                    <?= number_format($data['SUM(sembuh)'], 0) ?>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Menampilkan data Meninggal covid yang sudah dihitung dari semua wilayah -->
                <?php
                include '../db_connect.php';
                $query = mysqli_query($connection, "SELECT SUM(meninggal) FROM data_covid");
                while ($data = mysqli_fetch_array($query)) {
                ?>
                    <div class="col-sm-3">
                        <div class="card text-white bg-danger mb-3 shadow-sm">
                            <div class="card-body">
                                ...
                                <p class="card-text text-center fw-bolder" style="font-size: 30px;">
                                    <?= number_format($data['SUM(meninggal)'], 0) ?>
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text m-0">Terkonfirmasi : <b><?= number_format($row['positif']) ?></b></p>
                                        <p class="card-text m-0 text-success">Sembuh : <b><?= number_format($row['sembuh']) ?></b></p>
                                        <p class="card-text text-danger">Meninggal : <b><?= number_format($row['meninggal']) ?></b></p>
    ...
    <section id="footer">
        <footer class="text-center bg-light pb-5">
            Created with <i class="bi bi-heart-fill"></i> by <b><a href="https://www.instagram.com/alhusadif/" style="color: black; text-decoration: none;">Kelompok 1</a></b>
        </footer>
    </section>
    <!-- Akhir Footer -->
