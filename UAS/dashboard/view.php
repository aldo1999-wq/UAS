...
<head>
    ...
    <title>Data Pemantauan | Lihat Data</title>
...
<body>
    ...
    <section id="view-data">
        <div class="container">
            <div class="row table-responsive-sm mt-5">
                <div class="col">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="cetak-data.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-warning" target="_blank"><i class="bi bi-printer-fill"></i></a>
                                    </td>
                                </tr>
